...
<link rel="stylesheet" href="{!! \URLHelper::asset('libs/plugins/font-awesome-4.7.0/css/font-awesome.min.css', 'admin') !!}">
<link rel="stylesheet" href="{!! \URLHelper::asset('libs/plugins/ionicons-2.0.1/css/ionicons.min.css', 'admin') !!}">
